...
function classifySystem(r: Rule): string {
  ...
  if (/engine|misfire|knock|overheating|oil|idle|stalling|overrev|mount|egr|turbo|catalytic|warmup|throttle|intake_vacuum|maf_reading|^order_|_order_|kurtogram|spectral_kurtosis|order_2x|order_05/.test(id) || /RPM|rpm|throttle|maf|order_|kurtogram/.test(c)) return 'Двигатель'
