...
const AUDIO_ZONES = [
  ...
  { key: 'bearing', pos: [1.2, -0.3, 1.6] as [number, number, number],   color: '#f97316', minFreq: 600,  maxFreq: 2000,  label: 'Подшипники 0.6–2кГц', waveSpeed: 0.7, maxRadius: 0.9 },  // orange — front RIGHT hub (swapped with acc)
