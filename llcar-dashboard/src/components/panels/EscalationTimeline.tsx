          ...
          return (
            <div key={esc.rule_name} style={{ padding: '8px 10px', borderRadius: 2, background: `${color}06`, borderLeft: `3px solid ${color}` }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                <span style={{ fontSize: 12, fontFamily: "var(--f-body)", fontWeight: 600, color: theme.text.primary }}>
                  {esc.display}
                </span>
                <span style={{ fontSize: 8, fontFamily: "var(--f-display)", color, letterSpacing: '0.1em', padding: '1px 5px', border: `1px solid ${color}40`, borderRadius: 2 }}>
                  {label}
                </span>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 9, fontFamily: "var(--f-body)", color: theme.text.muted }}>
