  ...
  if (!recalls || recalls.length === 0) {
    return (
      <GlassPanel>
        ...
        <div style={{ textAlign: 'center', padding: '12px 0', color: theme.status.ok, fontSize: 12, fontFamily: "var(--f-body)" }}>
          ...
          return (
            <div key={recall.id || i} style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                <span style={{ fontSize: 12, fontFamily: "var(--f-body)", fontWeight: 600, color: theme.text.primary, lineHeight: 1.2 }}>
                  {recall.title_ru || recall.id}
                </span>
                <span style={{
                  fontSize: 8, fontFamily: "var(--f-display)", fontWeight: 600,
