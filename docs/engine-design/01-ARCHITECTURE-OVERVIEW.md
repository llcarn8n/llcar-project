...
- 36K DTC кодов, 764+ ситуаций, 298 отзывных (9-tier система уже реализована в D:\transfer4), 32 платформы
...
4. **4-level KB resolver** — universal → brand → model → generation. Сейчас уникальный контент в основном на universal+brand, но архитектура СРАЗУ строится на 4 уровня. Model и generation будут наполняться конкретными данными: двигатели, цены, типичные проблемы по поколениям.
