...
Universal (764 ситуации, 36K DTC)
  └→ Brand (58 брендов, до 1233 ситуаций у Hyundai)
      └→ Model (857 моделей, подмножество бренда)
          └→ Generation (66 поколений, добавляет уникальные из мануала)
```
...
298 кампаний. Matching по brand + model + year + system. VIN-диапазонов пока нет — только по совпадению марки/модели/года.
